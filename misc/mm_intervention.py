...
logging.basicConfig(filename='mm_run_intervention_2019AB.log',level=logging.DEBUG)
...
MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2021AA -V csly_it14 -Czy -R NCI_CDISC-GLOSS,SNOMEDCT_US,NCI_DTP,ATC,NCI_KEGG,FMA,NCI_CTRP,NCI_CDISC,NCI_CTCAE_3,MSH,VANDF,PDQ,MVX,NCI_NICHD,CCS,NCI_CTCAE,QMR,NCI_CRCH,AOD,NCI_GENC,ICF,HCPCS,NCI_NCI-GLOSS,NCI_GAIA,NCI_BioC,NCI_NCI-HL7,NCI_PI-RADS,NCI_CTEP-SDC,HPO,AIR,NCI_RENI,MEDLINEPLUS,NCI_DCP,NCI_NCPDP,MTHSPL,NCBI,HL7V2.5,NCI_CTCAE_5,CHV,LCH,NCI_PID,NCI_CDC,MED-RT,SOP,NCI_ZFin,NCI_FDA,COSTAR,NCI_BRIDG,MTHMST,NCI,MTHCMSFRF,SPN,ICD10PCS,RAM,ICPC,OMIM,MTHICD9,USP,LCH_NW,SNOMEDCT_VET,SRC,RXNORM,NCI_JAX,AOT,HGNC,UWDA,MCM,USPMG,GO,CSP,HL7V3.0,NCI_CareLex,ICD9CM,NCI_NCI-HGNC,CVX,MDR,NCI_ICH,NCI_DICOM,ICF-CY,MTH,NCI_UCUM,LNC,ICD10CM,CST,DXP,DRUGBANK --sldi --prune 30 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2021AA -V csly_it12 -Czy -R NCI_CDISC-GLOSS,SNOMEDCT_US,NCI_DTP,ATC,NCI_KEGG,FMA,NCI_CTRP,NCI_CDISC,NCI_CTCAE_3,MSH,VANDF,PDQ,MVX,NCI_NICHD,CCS,NCI_CTCAE,QMR,NCI_CRCH,AOD,NCI_GENC,ICF,HCPCS,NCI_NCI-GLOSS,NCI_GAIA,NCI_BioC,NCI_NCI-HL7,NCI_PI-RADS,NCI_CTEP-SDC,HPO,AIR,NCI_RENI,MEDLINEPLUS,NCI_DCP,NCI_NCPDP,MTHSPL,NCBI,HL7V2.5,NCI_CTCAE_5,CHV,LCH,NCI_PID,NCI_CDC,MED-RT,SOP,NCI_ZFin,NCI_FDA,COSTAR,NCI_BRIDG,MTHMST,NCI,MTHCMSFRF,SPN,ICD10PCS,RAM,ICPC,OMIM,MTHICD9,USP,LCH_NW,SNOMEDCT_VET,SRC,RXNORM,NCI_JAX,AOT,HGNC,UWDA,MCM,USPMG,GO,CSP,HL7V3.0,NCI_CareLex,ICD9CM,NCI_NCI-HGNC,CVX,MDR,NCI_ICH,NCI_DICOM,ICF-CY,MTH,NCI_UCUM,LNC,ICD10CM,CST,DXP,DRUGBANK --sldi --prune 30 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2021AA -V csly_it14 -Czy -v -c -G -I -R NCI_CDISC-GLOSS,SNOMEDCT_US,NCI_DTP,ATC,NCI_KEGG,FMA,NCI_CTRP,NCI_CDISC,NCI_CTCAE_3,MSH,VANDF,PDQ,MVX,NCI_NICHD,CCS,NCI_CTCAE,QMR,NCI_CRCH,AOD,NCI_GENC,ICF,HCPCS,NCI_NCI-GLOSS,NCI_GAIA,NCI_BioC,NCI_NCI-HL7,NCI_PI-RADS,NCI_CTEP-SDC,HPO,AIR,NCI_RENI,MEDLINEPLUS,NCI_DCP,NCI_NCPDP,MTHSPL,NCBI,HL7V2.5,NCI_CTCAE_5,CHV,LCH,NCI_PID,NCI_CDC,MED-RT,SOP,NCI_ZFin,NCI_FDA,COSTAR,NCI_BRIDG,MTHMST,NCI,MTHCMSFRF,SPN,ICD10PCS,RAM,ICPC,OMIM,MTHICD9,USP,LCH_NW,SNOMEDCT_VET,SRC,RXNORM,NCI_JAX,AOT,HGNC,UWDA,MCM,USPMG,GO,CSP,HL7V3.0,NCI_CareLex,ICD9CM,NCI_NCI-HGNC,CVX,MDR,NCI_ICH,NCI_DICOM,ICF-CY,MTH,NCI_UCUM,LNC,ICD10CM,CST,DXP,DRUGBANK --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2021AA -V csly_it14 -Czy -R NCI_CDISC-GLOSS,SNOMEDCT_US,NCI_DTP,ATC,NCI_KEGG,FMA,NCI_CTRP,NCI_CDISC,NCI_CTCAE_3,MSH,VANDF,PDQ,MVX,NCI_NICHD,CCS,NCI_CTCAE,QMR,NCI_CRCH,AOD,NCI_GENC,ICF,HCPCS,NCI_NCI-GLOSS,NCI_GAIA,NCI_BioC,NCI_NCI-HL7,NCI_PI-RADS,NCI_CTEP-SDC,HPO,AIR,NCI_RENI,MEDLINEPLUS,NCI_DCP,NCI_NCPDP,MTHSPL,NCBI,HL7V2.5,NCI_CTCAE_5,CHV,LCH,NCI_PID,NCI_CDC,MED-RT,SOP,NCI_ZFin,NCI_FDA,COSTAR,NCI_BRIDG,MTHMST,NCI,MTHCMSFRF,SPN,ICD10PCS,RAM,ICPC,OMIM,MTHICD9,USP,LCH_NW,SNOMEDCT_VET,SRC,RXNORM,NCI_JAX,AOT,HGNC,UWDA,MCM,USPMG,GO,CSP,HL7V3.0,NCI_CareLex,ICD9CM,NCI_NCI-HGNC,CVX,MDR,NCI_ICH,NCI_DICOM,ICF-CY,MTH,NCI_UCUM,LNC,ICD10CM,CST,DXP,DRUGBANK --sldi --prune 30 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2021AA -V csly_it13 -Czy -R NCI_CDISC-GLOSS,SNOMEDCT_US,NCI_DTP,ATC,NCI_KEGG,FMA,NCI_CTRP,NCI_CDISC,NCI_CTCAE_3,MSH,VANDF,PDQ,MVX,NCI_NICHD,CCS,NCI_CTCAE,QMR,NCI_CRCH,AOD,NCI_GENC,ICF,HCPCS,NCI_NCI-GLOSS,NCI_GAIA,NCI_BioC,NCI_NCI-HL7,NCI_PI-RADS,NCI_CTEP-SDC,HPO,AIR,NCI_RENI,MEDLINEPLUS,NCI_DCP,NCI_NCPDP,MTHSPL,NCBI,HL7V2.5,NCI_CTCAE_5,CHV,LCH,NCI_PID,NCI_CDC,MED-RT,SOP,NCI_ZFin,NCI_FDA,COSTAR,NCI_BRIDG,MTHMST,NCI,MTHCMSFRF,SPN,ICD10PCS,RAM,ICPC,OMIM,MTHICD9,USP,LCH_NW,SNOMEDCT_VET,SRC,RXNORM,NCI_JAX,AOT,HGNC,UWDA,MCM,USPMG,GO,CSP,HL7V3.0,NCI_CareLex,ICD9CM,NCI_NCI-HGNC,CVX,MDR,NCI_ICH,NCI_DICOM,ICF-CY,MTH,NCI_UCUM,LNC,ICD10CM,CST,DXP,DRUGBANK --sldi --prune 30 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2021AA -V csly_it12 -Czy -R NCI_CDISC-GLOSS,SNOMEDCT_US,NCI_DTP,ATC,NCI_KEGG,FMA,NCI_CTRP,NCI_CDISC,NCI_CTCAE_3,MSH,VANDF,PDQ,MVX,NCI_NICHD,CCS,NCI_CTCAE,QMR,NCI_CRCH,AOD,NCI_GENC,ICF,HCPCS,NCI_NCI-GLOSS,NCI_GAIA,NCI_BioC,NCI_NCI-HL7,NCI_PI-RADS,NCI_CTEP-SDC,HPO,AIR,NCI_RENI,MEDLINEPLUS,NCI_DCP,NCI_NCPDP,MTHSPL,NCBI,HL7V2.5,NCI_CTCAE_5,CHV,LCH,NCI_PID,NCI_CDC,MED-RT,SOP,NCI_ZFin,NCI_FDA,COSTAR,NCI_BRIDG,MTHMST,NCI,MTHCMSFRF,SPN,ICD10PCS,RAM,ICPC,OMIM,MTHICD9,USP,LCH_NW,SNOMEDCT_VET,SRC,RXNORM,NCI_JAX,AOT,HGNC,UWDA,MCM,USPMG,GO,CSP,HL7V3.0,NCI_CareLex,ICD9CM,NCI_NCI-HGNC,CVX,MDR,NCI_ICH,NCI_DICOM,ICF-CY,MTH,NCI_UCUM,LNC,ICD10CM,CST,DXP,DRUGBANK --sldi --prune 30 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2021AA -V csly_it9 -Czy -R NCI_CDISC-GLOSS,SNOMEDCT_US,NCI_DTP,ATC,NCI_KEGG,FMA,NCI_CTRP,NCI_CDISC,NCI_CTCAE_3,MSH,VANDF,PDQ,MVX,NCI_NICHD,CCS,NCI_CTCAE,QMR,NCI_CRCH,AOD,NCI_GENC,ICF,HCPCS,NCI_NCI-GLOSS,NCI_GAIA,NCI_BioC,NCI_NCI-HL7,NCI_PI-RADS,NCI_CTEP-SDC,HPO,AIR,NCI_RENI,MEDLINEPLUS,NCI_DCP,NCI_NCPDP,MTHSPL,NCBI,HL7V2.5,NCI_CTCAE_5,CHV,LCH,NCI_PID,NCI_CDC,MED-RT,SOP,NCI_ZFin,NCI_FDA,COSTAR,NCI_BRIDG,MTHMST,NCI,MTHCMSFRF,SPN,ICD10PCS,RAM,ICPC,OMIM,MTHICD9,USP,LCH_NW,SNOMEDCT_VET,SRC,RXNORM,NCI_JAX,AOT,HGNC,UWDA,MCM,USPMG,GO,CSP,HL7V3.0,NCI_CareLex,ICD9CM,NCI_NCI-HGNC,CVX,MDR,NCI_ICH,NCI_DICOM,ICF-CY,MTH,NCI_UCUM,LNC,ICD10CM,CST,DXP,DRUGBANK --sldi --prune 30 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2021AA -V csly_it6 -Cz -R NCI_CDISC-GLOSS,SNOMEDCT_US,NCI_DTP,ATC,NCI_KEGG,FMA,NCI_CTRP,NCI_CDISC,NCI_CTCAE_3,MSH,VANDF,PDQ,MVX,NCI_NICHD,CCS,NCI_CTCAE,QMR,NCI_CRCH,AOD,NCI_GENC,ICF,HCPCS,NCI_NCI-GLOSS,NCI_GAIA,NCI_BioC,NCI_NCI-HL7,NCI_PI-RADS,NCI_CTEP-SDC,HPO,AIR,NCI_RENI,MEDLINEPLUS,NCI_DCP,NCI_NCPDP,MTHSPL,NCBI,HL7V2.5,NCI_CTCAE_5,CHV,LCH,NCI_PID,NCI_CDC,MED-RT,SOP,NCI_ZFin,NCI_FDA,COSTAR,NCI_BRIDG,MTHMST,NCI,MTHCMSFRF,SPN,ICD10PCS,RAM,ICPC,OMIM,MTHICD9,USP,LCH_NW,SNOMEDCT_VET,SRC,RXNORM,NCI_JAX,AOT,HGNC,UWDA,MCM,USPMG,GO,CSP,HL7V3.0,NCI_CareLex,ICD9CM,NCI_NCI-HGNC,CVX,MDR,NCI_ICH,NCI_DICOM,ICF-CY,MTH,NCI_UCUM,LNC,ICD10CM,CST,DXP,DRUGBANK --sldi --prune 15 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2021AA -V csly_it5 -Cz -R NCI_CDISC-GLOSS,SNOMEDCT_US,NCI_DTP,ATC,NCI_KEGG,FMA,NCI_CTRP,NCI_CDISC,NCI_CTCAE_3,MSH,VANDF,PDQ,MVX,NCI_NICHD,CCS,NCI_CTCAE,QMR,NCI_CRCH,AOD,NCI_GENC,ICF,HCPCS,NCI_NCI-GLOSS,NCI_GAIA,NCI_BioC,NCI_NCI-HL7,NCI_PI-RADS,NCI_CTEP-SDC,HPO,AIR,NCI_RENI,MEDLINEPLUS,NCI_DCP,NCI_NCPDP,MTHSPL,NCBI,HL7V2.5,NCI_CTCAE_5,CHV,LCH,NCI_PID,NCI_CDC,MED-RT,SOP,NCI_ZFin,NCI_FDA,COSTAR,NCI_BRIDG,MTHMST,NCI,MTHCMSFRF,SPN,ICD10PCS,RAM,ICPC,OMIM,MTHICD9,USP,LCH_NW,SNOMEDCT_VET,SRC,RXNORM,NCI_JAX,AOT,HGNC,UWDA,MCM,USPMG,GO,CSP,HL7V3.0,NCI_CareLex,ICD9CM,NCI_NCI-HGNC,CVX,MDR,NCI_ICH,NCI_DICOM,ICF-CY,MTH,NCI_UCUM,LNC,ICD10CM,CST,DXP,DRUGBANK --sldi --prune 15 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2021AA -V csly_it3 -Cz -R NCI_CDISC-GLOSS,SNOMEDCT_US,NCI_DTP,ATC,NCI_KEGG,FMA,NCI_CTRP,NCI_CDISC,NCI_CTCAE_3,MSH,VANDF,PDQ,MVX,NCI_NICHD,CCS,NCI_CTCAE,QMR,NCI_CRCH,AOD,NCI_GENC,ICF,HCPCS,NCI_NCI-GLOSS,NCI_GAIA,NCI_BioC,NCI_NCI-HL7,NCI_PI-RADS,NCI_CTEP-SDC,HPO,AIR,NCI_RENI,MEDLINEPLUS,NCI_DCP,NCI_NCPDP,MTHSPL,NCBI,HL7V2.5,NCI_CTCAE_5,CHV,LCH,NCI_PID,NCI_CDC,MED-RT,SOP,NCI_ZFin,NCI_FDA,COSTAR,NCI_BRIDG,MTHMST,NCI,MTHCMSFRF,SPN,ICD10PCS,RAM,ICPC,OMIM,MTHICD9,USP,LCH_NW,SNOMEDCT_VET,SRC,RXNORM,NCI_JAX,AOT,HGNC,UWDA,MCM,USPMG,GO,CSP,HL7V3.0,NCI_CareLex,ICD9CM,NCI_NCI-HGNC,CVX,MDR,NCI_ICH,NCI_DICOM,ICF-CY,MTH,NCI_UCUM,LNC,ICD10CM,CST,DXP,DRUGBANK --sldi --prune 15 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2021AA -V csly_it3 -Cz -R NCI_CDISC-GLOSS,SNOMEDCT_US,NCI_DTP,ATC,NCI_KEGG,FMA,NCI_CTRP,NCI_CDISC,NCI_CTCAE_3,MSH,VANDF,PDQ,MVX,NCI_NICHD,CCS,NCI_CTCAE,QMR,NCI_CRCH,AOD,NCI_GENC,ICF,HCPCS,NCI_NCI-GLOSS,NCI_GAIA,NCI_BioC,NCI_NCI-HL7,NCI_PI-RADS,NCI_CTEP-SDC,HPO,AIR,NCI_RENI,MEDLINEPLUS,NCI_DCP,NCI_NCPDP,MTHSPL,NCBI,HL7V2.5,NCI_CTCAE_5,CHV,LCH,NCI_PID,NCI_CDC,MED-RT,SOP,NCI_ZFin,NCI_FDA,COSTAR,NCI_BRIDG,MTHMST,NCI,MTHCMSFRF,SPN,ICD10PCS,RAM,ICPC,OMIM,MTHICD9,USP,LCH_NW,SNOMEDCT_VET,SRC,RXNORM,NCI_JAX,AOT,HGNC,UWDA,MCM,USPMG,GO,CSP,HL7V3.0,NCI_CareLex,ICD9CM,NCI_NCI-HGNC,CVX,MDR,NCI_ICH,NCI_DICOM,ICF-CY,MTH,NCI_UCUM,LNC,ICD10CM,CST,DXP,DRUGBANK --sldi --prune 15 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2020AB -V csly_it13 -Cz -R NCI_CDISC-GLOSS,SNOMEDCT_US,NCI_DTP,ATC,NCI_KEGG,FMA,NCI_CTRP,NCI_CDISC,NCI_CTCAE_3,MSH,VANDF,PDQ,MVX,NCI_NICHD,CCS,NCI_CTCAE,QMR,NCI_CRCH,AOD,NCI_GENC,ICF,HCPCS,NCI_NCI-GLOSS,NCI_GAIA,NCI_BioC,NCI_NCI-HL7,NCI_PI-RADS,NCI_CTEP-SDC,HPO,AIR,NCI_RENI,MEDLINEPLUS,NCI_DCP,NCI_NCPDP,MTHSPL,NCBI,HL7V2.5,NCI_CTCAE_5,CHV,LCH,NCI_PID,NCI_CDC,MED-RT,SOP,NCI_ZFin,NCI_FDA,COSTAR,NCI_BRIDG,MTHMST,NCI,MTHCMSFRF,SPN,ICD10PCS,RAM,ICPC,OMIM,MTHICD9,USP,LCH_NW,SNOMEDCT_VET,SRC,RXNORM,NCI_JAX,AOT,HGNC,UWDA,MCM,USPMG,GO,CSP,HL7V3.0,NCI_CareLex,ICD9CM,NCI_NCI-HGNC,CVX,MDR,NCI_ICH,CCS_10,NCI_DICOM,ICF-CY,MTH,NCI_UCUM,LNC,ICD10CM,CST,DXP,DRUGBANK --sldi --prune 15 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2020AB -V csly_it12 -Cz --sldi --prune 15 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2020AB -V csly_it11 -Cz --sldi --prune 15 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2020AB -V csly_it10 -Cz --sldi --prune 15 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2020AB -V csly -Cz --sldi --prune 15 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2020AB -V NLM -Cz --sldi --prune 15 --XMLf'
# MMQUERY_MMSH = '/home/j.kim/public_mm/bin/metamap -Z 2019AB -V NLM -Cz --sldi --prune 15 --XMLf'
# MMQUERY_MMSH = '/data-processing/public_mm_2020ab_with_dfb/bin/metamap -Z 2020AB -V csly -Czy -c -G -I --XMLf'
# MMQUERY_MMSH = '/home/manolis/metamap/public_mm/bin/metamap -Z 2019AB -V NLM -Cz --sldi --prune 15 --XMLf'
...
ALLOWED_CONCEPT_CATS = ['CHEM', 'LIVB', 'T025']
...
def clean_entity_string(request_string):
    ...
    for i in range(len(request_string_tokens)):
        ...
        if request_string_tokens[i].lower() not in MMQUERY_WORD_BLACKLIST:
            token_lemma = ''.join(x.lemma_ for x in MMQUERY_NLP(request_string_tokens[i]))
...
def clean_query_string(request_string):
    ...
    Clean an input string so that it can match be employed as part of a MetaMap query
        ...
        Outputs:
            cleaned form of the input string
    """
    # plain_string = unicodedata.normalize('NFKD', u'' + request_string).encode('ASCII', 'ignore').decode()
    plain_string = unicodedata.normalize('NFKD', u'' + request_string).encode('ASCII', 'ignore').decode()
    # plain_string = unicodedata.normalize('NFKD', u'' + request_string).encode('ASCII', 'ignore').decode('utf-8')
...
def get_best_record(xml, request_string, umls_cat_abbrv, umls_cat_group):
    ...
    try:
        ...
        logging.warning('XML format error')
...
def invoke_mm1(cmd_task):
    ...
    return subprocess.check_output(cmd_task, shell=True).decode('utf-8').split(MMQUERY_XML_HEADER)[1]
...
if __name__ == '__main__':
    ...
    # MMQUERY_INTERVENTION_INDEX = 17
    # MMQUERY_INTERVENTION_REQUEST = 18
    # MMQUERY_INTERVENTION_CONCEPT = 19
    # MMQUERY_INTERVENTION_CUI = 20 
    # MMQUERY_INTERVENTION_CATEGORY = 21
    # MMQUERY_INTERVENTION_ALL_CONCEPTS = 22

    # MMQUERY_INTERVENTION_INDEX = 1
    # MMQUERY_INTERVENTION_REQUEST = 2
    # MMQUERY_INTERVENTION_CONCEPT = 3
    # MMQUERY_INTERVENTION_CUI = 4
    # MMQUERY_INTERVENTION_CATEGORY = 5
    # MMQUERY_INTERVENTION_ALL_CONCEPTS = 6

    MMQUERY_INTERVENTION_INDEX = 3
    MMQUERY_INTERVENTION_REQUEST = 4
    MMQUERY_INTERVENTION_CONCEPT = 5
    MMQUERY_INTERVENTION_CUI = 6
    MMQUERY_INTERVENTION_CATEGORY = 7
    MMQUERY_INTERVENTION_ALL_CONCEPTS = 8
    ...
    if not MMQUERY_MM_MEMOIZE:
        ...
        premm_dictionary["therapeutic radiology procedure"] = ([1000, "C1522449", "Therapeutic radiology procedure","PROC|Procedures|T061|Therapeutic or Preventive Procedure", "Therapeutic radiology procedure"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["saline"] = ([1000, "C0036082", "Saline Solution","OBJC|Objects|T167|Substance", "Saline"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["intensity-modulated therapeutic radiology procedure"] = ([1000, "C1522449", "Therapeutic radiology procedure","PROC|Procedures|T061|Therapeutic or Preventive Procedure", "Therapeutic radiology procedure"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["3-dimensional conformal therapeutic radiology procedure"] = ([1000, "C1522449", "Therapeutic radiology procedure","PROC|Procedures|T061|Therapeutic or Preventive Procedure", "Therapeutic radiology procedure"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["physical activity"] = ([1000, "C0026606", "Exercise","ACTI|Activities & Behaviors|T056|Daily or Recreational Activity", "Physical Activity"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["exercise training"] = ([1000, "C1522704", "Exercise Pain Management","OBJC|Objects|T167|Substance", "Exercise Pain Management"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["internal therapeutic radiology procedure"] = ([1000, "C1522449", "Therapeutic radiology procedure","PROC|Procedures|T061|Therapeutic or Preventive Procedure", "Therapeutic radiology procedure"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["hypofractionated therapeutic radiology procedure"] = ([1000, "C1522449", "Therapeutic radiology procedure","PROC|Procedures|T061|Therapeutic or Preventive Procedure", "Therapeutic radiology procedure"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["proton beam therapeutic radiology procedure"] = ([1000, "C1522449", "Therapeutic radiology procedure","PROC|Procedures|T061|Therapeutic or Preventive Procedure", "Therapeutic radiology procedure"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["intensity modulated therapeutic radiology procedure"] = ([1000, "C1522449", "Therapeutic radiology procedure","PROC|Procedures|T061|Therapeutic or Preventive Procedure", "Therapeutic radiology procedure"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["physical exercise"] = ([1000, "C1522704", "Exercise Pain Management","OBJC|Objects|T167|Substance", "Exercise Pain Management"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["mindfulness-based stress reduction"] = ([1000, "C3542996", "Mindfulness","PHYS|Physiology|T041|Mental Process", "Mindfulness"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["walking"] = ([1000, "C0080331", "Walking (activity)","ACTI|Activities & Behaviors|T056|Daily or Recreational Activity", "Walking"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["mindfulness"] = ([1000, "C3542996", "Mindfulness","PHYS|Physiology|T041|Mental Process", "Mindfulness"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["mesenchymal stem cells"] = ([1000, "C1257990", "Mesenchymal Stem Cell Transplantation","PROC|Procedures|T061|Therapeutic or Preventive Procedure", "Mesenchymal Stem Cell Transplantation"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["0 9% saline"] = ([1000, "C0036082", "Saline Solution","OBJC|Objects|T167|Substance", "Saline"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["mindfulness based stress reduction"] = ([1000, "C3542996", "Mindfulness","PHYS|Physiology|T041|Mental Process", "Mindfulness"] + [1], MMQUERY_CSV_DEFAULT_FIELD)
        premm_dictionary["tai chi"] = ([1000, "C0376403", "Tai Ji","ACTI|Activities & Behaviors|T056|Daily or Recreational Activity", "Taiji"] + [1], MMQUERY_CSV_DEFAULT_FIELD)



    # prepare a local metamap dictionary
    localmm_dictionary = dict()
    ...
    for row in csv_in_rows:
        ...
        # there is no need to launch a MetaMap request when the string is already on the local metamap dictionary
        elif request_string in localmm_dictionary:
            [score, cui, preferred, semtypes, matched_candidate] = localmm_dictionary[request_string][0]
            all_concepts =  localmm_dictionary[request_string][1]
            output_rows[-1][MMQUERY_INTERVENTION_REQUEST] = request_string
            output_rows[-1][MMQUERY_INTERVENTION_CONCEPT] = preferred
            output_rows[-1][MMQUERY_INTERVENTION_CUI] = cui
            output_rows[-1][MMQUERY_INTERVENTION_CATEGORY] = semtypes
        ...
        # otherwise we need to query MetaMap, but we will launch queries in batches for speed
            ...
            misc_chars = ["-","=","+","-","&","*","%","!","@","#","$","^","<",">","[","]","{","}","~",",",".","?",":"]
            if ((request_string.split()) and (request_string.strip() not in misc_chars)):

                batch_request_strings.append(request_string)
                output_rows_dict_mapped[-1].append(False)

            # avoid querying MetaMap for empty strings, and consider them completed
            else:
        ...
        if len(batch_request_strings) >= REQUEST_SIZE or (row_index + 1) == row_count:
            ...
            for xml_data in batch_xmls:
                ...
                if MMQUERY_MM_MEMOIZE:
                    ...
                    localmm_dictionary[batch_request_strings[xml_index]] = (mapped_primary , all_concepts)
                xml_index += 1

            if len(metamap_results_primary) != len(batch_request_strings):
