...
if __name__ == '__main__':
    ...
    MMQUERY_INTERVENTION_INDEX = 9
    MMQUERY_INTERVENTION_REQUEST = 10
    MMQUERY_INTERVENTION_CONCEPT = 11
    MMQUERY_INTERVENTION_CUI = 12
    MMQUERY_INTERVENTION_CATEGORY = 13
    MMQUERY_INTERVENTION_ALL_CONCEPTS = 14
