...
| Document | Purpose |
|----------|---------|
| [docs/pipeline-steps.md](docs/pipeline-steps.md) | Detailed per-step reference (scripts, inputs, outputs, logic) |
| [docs/running-the-pipeline.md](docs/running-the-pipeline.md) | VM run procedure, prerequisites, troubleshooting |
| [docs/umls-update.md](docs/umls-update.md) | UMLS release update procedure (MetaMap, dictionaries, MeSH) |
| [docs/outputs-and-downstream.md](docs/outputs-and-downstream.md) | GCS layout, evidence contract, downstream consumers, release stats |
...
See [docs/outputs-and-downstream.md](docs/outputs-and-downstream.md) for the full output contract and downstream handoff.
...
See [docs/running-the-pipeline.md](docs/running-the-pipeline.md) for prerequisites and the full procedure.
